            ...
            >
              ...
              <div className="flex flex-col justify-between p-4 pt-2 h-full">
                <div className="flex-grow">
                  <h3 className="text-xl font-semibold text-black dark:text-neutral-100 text-center">{offer.title}</h3>
                  <p className="text-sm text-neutral-600 dark:text-neutral-100 mt-1 text-center">{offer.description}</p>
                ...
                <div className="mt-4">
                  <Link href={offer.link}>
                    <Button className="w-full rounded-full px-6 py-3 bg-black text-white cursor-pointer hover:bg-black dark:hover:bg-black">
                      Ver Mais
                    </Button>
                  </Link>
                </div>
